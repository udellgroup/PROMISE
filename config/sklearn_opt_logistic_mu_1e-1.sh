...
do
    python sklearn_opt.py --data $name --problem logistic --iters 1000 --mu 0.1 --dest ./performance_results_mu_1e-1
done
for name in "${datasets2[@]}"
do
    python sklearn_opt.py --data $name --problem logistic --iters 2000 --mu 0.1 --dest ./performance_results_mu_1e-1
done